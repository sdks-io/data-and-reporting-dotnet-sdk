// <copyright file="CustomerManagementV2Cardtype401ErrorException.cs" company="APIMatic">
...
namespace ShellDataReportingAPIs.Standard.Exceptions
{
    ...
    /// </summary>
    public class CustomerManagementV2Cardtype401ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerManagementV2Cardtype401ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public CustomerManagementV2Cardtype401ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"CustomerManagementV2Cardtype401ErrorException : ({string.Join(", ", toStringOutput)})";
        }
