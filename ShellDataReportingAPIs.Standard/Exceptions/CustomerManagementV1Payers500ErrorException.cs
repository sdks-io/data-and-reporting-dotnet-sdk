// <copyright file="CustomerManagementV1Payers500ErrorException.cs" company="APIMatic">
...
namespace ShellDataReportingAPIs.Standard.Exceptions
{
    ...
    /// </summary>
    public class CustomerManagementV1Payers500ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerManagementV1Payers500ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public CustomerManagementV1Payers500ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"CustomerManagementV1Payers500ErrorException : ({string.Join(", ", toStringOutput)})";
        }
