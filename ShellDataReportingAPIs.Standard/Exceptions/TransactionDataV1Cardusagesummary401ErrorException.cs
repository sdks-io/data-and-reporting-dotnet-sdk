// <copyright file="TransactionDataV1Cardusagesummary401ErrorException.cs" company="APIMatic">
...
namespace ShellDataReportingAPIs.Standard.Exceptions
{
    ...
    /// </summary>
    public class TransactionDataV1Cardusagesummary401ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionDataV1Cardusagesummary401ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public TransactionDataV1Cardusagesummary401ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"TransactionDataV1Cardusagesummary401ErrorException : ({string.Join(", ", toStringOutput)})";
        }
