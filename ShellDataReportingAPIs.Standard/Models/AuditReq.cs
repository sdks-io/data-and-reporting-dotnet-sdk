// <copyright file="AuditReq.cs" company="APIMatic">
...
namespace ShellDataReportingAPIs.Standard.Models
{
    ...
    public class AuditReq
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditReq"/> class.
        /// </summary>
        public AuditReq()
        {
        }
        ...
        public AuditReq(
            Models.AuditRequest filters = null,
            int? page = 1,
            int? pageSize = 50)
        {
        ...
        public Models.AuditRequest Filters { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"AuditReq : ({string.Join(", ", toStringOutput)})";
        }
