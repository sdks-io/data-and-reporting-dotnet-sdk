// <copyright file="TransactionDataV1Fuelconsumption403ErrorException.cs" company="APIMatic">
...
namespace ShellDataReportingAPIs.Standard.Exceptions
{
    ...
    /// </summary>
    public class TransactionDataV1Fuelconsumption403ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionDataV1Fuelconsumption403ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public TransactionDataV1Fuelconsumption403ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"TransactionDataV1Fuelconsumption403ErrorException : ({string.Join(", ", toStringOutput)})";
        }
