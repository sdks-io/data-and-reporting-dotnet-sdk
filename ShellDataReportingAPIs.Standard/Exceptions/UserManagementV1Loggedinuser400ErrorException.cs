// <copyright file="UserManagementV1Loggedinuser400ErrorException.cs" company="APIMatic">
...
namespace ShellDataReportingAPIs.Standard.Exceptions
{
    ...
    /// </summary>
    public class UserManagementV1Loggedinuser400ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserManagementV1Loggedinuser400ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public UserManagementV1Loggedinuser400ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"UserManagementV1Loggedinuser400ErrorException : ({string.Join(", ", toStringOutput)})";
        }
