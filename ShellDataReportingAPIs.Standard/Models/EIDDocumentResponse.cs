...
namespace ShellDataReportingAPIs.Standard.Models
{
    ...
    public class EIDDocumentResponse
    {
        ...
        public EIDDocumentResponse(
            ...
            string status = null,
            List<Models.EIDDocument> document = null,
            int? pageSize = null,
            int? page = null,
            int? totalPages = null,
        ...
        public List<Models.EIDDocument> Document { get; set; }
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"Document = {(this.Document == null ? "null" : $"[{string.Join(", ", this.Document)} ]")}");
